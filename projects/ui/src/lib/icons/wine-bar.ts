...
@Component({
    selector: 'icon-wine-bar',
    template: `<svg
        [attr.width]="width"
        data-bspk-name="WineBar"
        data-type="material"
