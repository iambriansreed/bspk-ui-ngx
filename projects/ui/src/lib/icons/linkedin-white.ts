...
@Component({
    selector: 'icon-linkedin-white',
    template: `<svg
        [style.width]="width"
        data-bspk-name="LinkedinWhite"
        data-type="brand"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        fill="none"
    >
        <g clip-path="url(#SvgLinkedinWhite__a)">
            <path
        ...
        <defs>
            <clipPath id="SvgLinkedinWhite__a">
                <rect width="20" height="20" fill="white" transform="translate(2 2)" />
            </clipPath>
        </defs>
    </svg>`,
    styles: ['icon-linkedin-white { display: contents; }'],
    encapsulation: ViewEncapsulation.None,
})
export class IconLinkedinWhite {
