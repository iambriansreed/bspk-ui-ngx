...
@Component({
  ...
  >
    <g clip-path="url(#SvgFlagNicaragua__a)">
      ...
      <path
        d="M1.5 5.00024H22.5V9.6668H1.5V5.00024ZM1.5 14.3334H22.5V19H1.5V14.3334Z"
        fill="#338AF3"
      />
      <path
      ...
      />
      <path
        d="M12.8434 12.2435L12 12L11.1566 12.2435L10.8754 12.7304H13.1246L12.8434 12.2435Z"
        fill="#338AF3"
      />
