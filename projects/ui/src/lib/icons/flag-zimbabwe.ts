...
@Component({
  ...
  >
    <g clip-path="url(#SvgFlagZimbabwe__a)">
      ...
      <path
        d="M1.5 7.00415H22.5V9.0085H1.5V7.00415ZM1.5 15.0216H22.5V17.0259H1.5V15.0216Z"
        fill="#FFDA44"
      />
      <path d="M1.5 5H22.5V7.00435H1.5V5Z" fill="#057F44" />
      <path
        d="M1.5 9.00879H22.5V11.0131H1.5V9.00879ZM1.5 13.0175H22.5V15.0219H1.5V13.0175Z"
        fill="#D80027"
      />
