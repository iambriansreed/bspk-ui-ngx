...
import { COMPONENT_PHASE_COLORS } from '../../projects/shared/src/utils';
    ...
    template: \`
           ...
           ${
               !component.inputs.length
                   ...
                   : `
           <h3>Inputs</h3>
            <app-type-props [props]='componentInputs' />
            `
           }
            ${
                !component.outputs.length
                    ...
                    : `
            <h3>Outputs</h3>
            <app-type-props [props]='componentOutputs' />
            `
            }
${
...
export class ${component.name}Page {
    ...
    componentInputs = ${JSON.stringify(component.inputs)};

    componentOutputs = ${JSON.stringify(component.outputs)};
